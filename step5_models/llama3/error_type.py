...
def detailed_error_analysis_llama3_colab():
    ...
    # Eğitilen LoRA adaptörlerini temel modele giydiriyoruz
...
"""
        ...
        with torch.no_grad():
            outputs = model.generate(
                **inputs,
                ...
                temperature=0.1,  # Deterministik sonuçlar için düşük sıcaklık
                do_sample=True,
                pad_token_id=tokenizer.eos_token_id
            )

        # Sadece asistanın ürettiği kısmı al (Prompt'u kes)
    ...
    print("\n" + "=" * 65)
    print(f"📈 LLAMA 3.1 MODEL PERFORMANS ÖZETİ (Toplam Test: {len(test_data)})")
    print("=" * 65)
...
if __name__ == "__main__":
    detailed_error_analysis_llama3_colab()