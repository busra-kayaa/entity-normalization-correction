...
def test_t5_base_categorized():
    ...
    # Model Yolu (Dinamik yol kullanımı daha güvenlidir)
    model_path = t5_base_folder / "final_t5_base_model"

    # Çıktı Dosya Yolları
    output_excel = reports_dir / "t5_base_manual_test_results.xlsx"
    output_text = reports_dir / "t5_base_manual_test_report.txt"
    ...
    # 2. Kategorize Edilmiş Genişletilmiş Test Senaryoları
    test_cases = [
        ...
        # --- 3) TYPOGRAPHIC (Yazım Hataları: Omission, Insertion, Transposition, Substitution)
        ...
        # --- 6) NONE (Doğruyu Bozmama / Identity)
    ...
    print(f"🧪 {len(test_cases)} manuel senaryo T5-Base ile test ediliyor...\n" + "=" * 80)
    ...
    report_header = f"""
==================================================
      T5-BASE MANUEL TEST KATEGORİ RAPORU
==================================================
Tarih: {report_time}
...
"""
    ...
    print(report_header)
    print(f"✅ Manuel test tamamlandı. Raporlar şuraya kaydedildi: {reports_dir}")


if __name__ == "__main__":
    test_t5_base_categorized()