...
def test_t5_small_expanded_and_save():
    ...
    # Model Yolu
    model_path = r"C:\Users\Busra\entity_normalization\step5_models\t5_small\final_model"

    # Çıktı Dosya Yolları (reports klasörü içine)
    output_excel = reports_dir / "small_manuel_test_results.xlsx"
    output_text = reports_dir / "small_manuel_test_report.txt"
    ...
    print("\n🚀 T5-Small Manuel Test Başlatıldı...\n" + "=" * 75)
    ...
    report_text = f"""
==================================================
      GENİŞLETİLMİŞ MANUEL TEST RAPORU (T5-SMALL)
==================================================
Tarih: {report_time}
...
if __name__ == "__main__":
    test_t5_small_expanded_and_save()